...
ra = copy.deepcopy(env.ini_ra)
print(ra.state)
states2, move_actions2, release_actions2, rewards2 = policy.greedy_plus_random_explorer(ra, 0.9, 0.1, 5)

ra = copy.deepcopy(env.ini_ra)
print(ra.state)
states3, move_actions3, release_actions3, rewards3 = policy.power_plus_random_explorer(ra, 0.9, 0.1, 5, 0.1)
